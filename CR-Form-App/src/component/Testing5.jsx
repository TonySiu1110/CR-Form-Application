...
import New_position from "./new_position";
  ...
  const renderPage = () => {
    switch (currentPage) {
        ...
        return (
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='dropdown-container'>
                    ...
                    <option value="update_existing_job">Update Existing Job</option>
      ...
      case 2:
        ...
        <>
            {/* rendering 1 */}
            {formData.classificationService === "Classify_New_Position" && (
            <>
...
{/* Rendering 2 */}
{formData.classificationService === "update_existing_job" && (
            <>
            ...
            <div className="form-row">
<div className="form-group">
    <label htmlFor="division">Ministry Code</label>
            <input
            type="text"
            id="ministry_code"
            name="ministry_code"
...
<div className="form-row">
    ...
    >
        ...
        <option value="permanent">Permanent</option>
            ...
            {formData.positionStatus === 'temporary' && (
                <div className='dropdown-container'>
                <label htmlFor="dropdown" className="dropdown-label">Duration</label>
                <select
                id="dropdown"
                className="dropdown-select"
                name="duration"
                ...
                onChange={handleChange}
                >
                <option value="up_to_6">Up to 6-months</option>
                <option value="up_to_12">Up to 12 months</option>
                <option value="up_to_18">Up to 18 months</option>
                <option value="up_to_24">Up to 24 months</option>
                <option value="over_24">Over 24 months</option>
                </select>
            </div>
            )}  
...
{/* Rendering 3 */}
{formData.classificationService === "reorganization_a_new_organization" && (
            <>
